        ...
        <div class="lc-container lc-hero__inner">
            <div class="lc-hero__text">
                <div class="lc-badge">
                    ...
                    Trusted by 2,000+ verified locals in your city
                </div>
                <h1 class="lc-hero__headline">
                    Quality local services,<br>
                    <span class="lc-hero__accent">right at your door.</span>
                </h1>
                <p class="lc-hero__sub">
                    Find verified local professionals in seconds — transparent upfront pricing,
                    instant scheduling, and zero surprises.
                </p>
                <div class="lc-hero__actions">
                    <a href="<?= $base_url ?>/auth/register_user.php" class="lc-btn lc-btn--primary">
                        Get started free
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                    </a>
                    <a href="<?= $base_url ?>/auth/login.php" class="lc-btn lc-btn--ghost">Member login</a>
                </div>
                <div class="lc-hero__trust">
                    ...
                    <span class="lc-trust-text">
                        <strong>4.9 ★</strong> from 1,200+ verified customer reviews
                    </span>
                </div>
            </div>
    ...
    <section class="lc-section lc-section--white">
        <div class="lc-container">
            ...
            <div class="lc-categories">
                <?php
                $cats = [
                    ['icon' => '⚡', 'name' => 'Electrician',   'count' => '48 pros', 'q' => 'Electrician'],
                    ['icon' => '🔧', 'name' => 'Plumbing',       'count' => '62 pros', 'q' => 'Plumbing'],
                    ['icon' => '🧹', 'name' => 'Cleaning',       'count' => '91 pros', 'q' => 'Cleaning'],
                    ['icon' => '🪵', 'name' => 'Carpentry',      'count' => '37 pros', 'q' => 'Carpentry'],
                    ['icon' => '🖌️', 'name' => 'Painting',      'count' => '55 pros', 'q' => 'Painting'],
                    ['icon' => '🐛', 'name' => 'Pest Control',   'count' => '29 pros', 'q' => 'Pest'],
                ];
                foreach ($cats as $cat): ?>
                <a href="<?= $base_url ?>/user/search_services.php?search=<?= urlencode($cat['q']) ?>" class="lc-cat-card">
        ...
        <div class="lc-container">
            ...
            <div class="lc-steps">
                ...
                <div class="lc-step">
                    ...
                    <p class="lc-step__desc">Sit back while a verified expert handles the job with guaranteed satisfaction.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="lc-section lc-section--white">
        <div class="lc-container">
            <div class="lc-section__header">
                ...
                <p class="lc-section__desc">Every feature is designed to connect communities with dependable local craftspeople.</p>
            </div>
            <div class="lc-features">
                <div class="lc-feature-card">
                    ...
                    <a href="<?= $base_url ?>/auth/register_user.php" class="lc-feature-card__link">Learn how we vet →</a>
                </div>
                <div class="lc-feature-card lc-feature-card--featured">
                    ...
                    <p class="lc-feature-card__desc">Book a service in under 60 seconds. Pick from verified local professionals directly online.</p>
                    <a href="<?= $base_url ?>/auth/register_user.php" class="lc-feature-card__link">Try it now →</a>
                </div>
                <div class="lc-feature-card">
                    ...
                    <h3 class="lc-feature-card__title">Transparent rates</h3>
                    <p class="lc-feature-card__desc">Upfront pricing, detailed job overviews, and zero hidden fees. Pay only when satisfied.</p>
                    <a href="<?= $base_url ?>/auth/register_user.php" class="lc-feature-card__link">See pricing →</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="lc-stats-bar">
        <div class="lc-container lc-stats-bar__inner">
            ...
            <div class="lc-stat">
                ...
                <span class="lc-stat__label">Avg. booking response</span>
            </div>
        </div>
    </section>
    ...
    <section class="lc-section lc-section--dark">
        <div class="lc-container lc-cta__inner">
            <div class="lc-cta__text">
                ...
                <h2 class="lc-cta__title">Ready to grow your local business?</h2>
                ...
                <div class="lc-cta__actions">
                    <a href="<?= $base_url ?>/auth/register_provider.php" class="lc-btn lc-btn--white">
                        Join as a provider
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                    </a>
                    <a href="<?= $base_url ?>/auth/login.php" class="lc-btn lc-btn--ghost-white">Already a member?</a>
                </div>
            </div>
            <div class="lc-cta__checklist" aria-hidden="true">
                ...
                $perks = [
                    ...
                    'Direct contact and verified scheduling',
                ];
